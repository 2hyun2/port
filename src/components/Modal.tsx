                                        ...
                                        <article className="modal-content">
                                                ...
                                                <div className="modal-chapter">
                                                        ...
                                                        <p>
                                                                ...
                                                                임대형 솔루션(Cafe24)의 구조적 한계로 인해 이루고자 하는 프로젝트를 원활히 진행하기 힘들다 느꼈을떄, <br className="view-m" />
                                                ...
                                                <div className="modal-chapter">
                                                        ...
                                                        <p>
                                                                ...
                                                                메인 제품 코드와 파생 옵션들을 보유중이며, 기존 ecount-api 서비스는 조회가 까다롭고 불편하다는 의견이 있었습니다. <br />
                                                                해서 혼자 모든 과정을 설계하여 사내 IP 망 + 특정 계정 + 실시간 검색 기능을 넣은 <br className="view-m" />
                                                                 node 기반 서버 API를 제작하게 되었습니다. <br />
                                                                재고 조회를 실시간으로 파악해야하는 MD, CS 영역에서의 호응이 좋았으며, 이제는 없으면 불편함을 느끼는 서비스에 이르었습니다.
                                                                매출 성과로 직결되진 않았지만, 같이 일하는 동료의 효율성이 개선되는 모습을 보니 좀 더 좋았습니다.
                                                        </p>
                                                </div>
                                                <div className="modal-chapter">
                                                        <h5>가치관 및 신조</h5>
